document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadDictionary() {
        try {
            const lastHash = localStorage.getItem("houseJsonHash"); // Paskutinė JSON versija
            ...
            if (lastHash !== newHash) {
                ...
                localStorage.setItem("shuffledHouseWords", JSON.stringify(words));
                localStorage.setItem("houseJsonHash", newHash);
