document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadDictionary() {
        try {
            const lastHash = localStorage.getItem("foodJsonHash"); // Paskutinė JSON versija
            ...
            if (lastHash !== newHash) {
                ...
                localStorage.setItem("shuffledFoodWords", JSON.stringify(words));
                localStorage.setItem("foodJsonHash", newHash);
                ...
                words = JSON.parse(localStorage.getItem("shuffledFoodWords"));
            }
