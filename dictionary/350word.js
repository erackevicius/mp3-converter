document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadDictionary() {
        try {
            const lastHash = localStorage.getItem("350wordJsonHash"); // Paskutinė JSON versija
            const response = await fetch("./350word.json");
            ...
            if (lastHash !== newHash) {
                ...
                localStorage.setItem("shuffled350wordWords", JSON.stringify(words));
                localStorage.setItem("350wordJsonHash", newHash);
                ...
                words = JSON.parse(localStorage.getItem("shuffled350wordWords"));
            }
