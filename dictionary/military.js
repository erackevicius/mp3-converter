document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadDictionary() {
        try {
            const lastHash = localStorage.getItem("militaryJsonHash"); // Paskutinė JSON versija
            const response = await fetch("./military.json");
            ...
            if (lastHash !== newHash) {
                ...
                localStorage.setItem("shuffledMilitaryWords", JSON.stringify(words));
                localStorage.setItem("militaryJsonHash", newHash);
                ...
                words = JSON.parse(localStorage.getItem("shuffledMilitaryWords"));
            }
