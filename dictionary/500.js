document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadDictionary() {
        try {
            const lastHash = localStorage.getItem("500JsonHash"); // Paskutinė JSON versija
            const response = await fetch("./500.json");
            ...
            if (lastHash !== newHash) {
                ...
                localStorage.setItem("shuffled500Words", JSON.stringify(words));
                localStorage.setItem("500JsonHash", newHash);
                ...
                words = JSON.parse(localStorage.getItem("shuffled500Words"));
            }
