document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadDictionary() {
        try {
            const lastHash = localStorage.getItem("monthlyJsonHash"); // Paskutinė JSON versija
            ...
            if (lastHash !== newHash) {
                ...
                localStorage.setItem("shuffledMonthlyWords", JSON.stringify(words));
                localStorage.setItem("monthlyJsonHash", newHash);
                ...
                words = JSON.parse(localStorage.getItem("shuffledMonthlyWords"));
            }
